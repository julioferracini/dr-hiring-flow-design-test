// BACKUP — DueDate.tsx antes do delay no roulette do botao apos calendario
...
export default function DueDateScreen({
  ...
  // Label como ReactNode: texto de continue estatico + data com roulette
  ...
  return (
    <div className="bg-white content-stretch flex flex-col items-start overflow-clip relative size-full" data-name="DueDate">
      ...
      {/* Conteudo scrollavel com padding-bottom para a barra fixa */}
      ...
      {/* Barra de acao — immediate=true pois ha data pre-selecionada */}
      <BottomActionBar
