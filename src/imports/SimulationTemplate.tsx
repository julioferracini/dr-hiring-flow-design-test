import svgPaths from "./svg-1wpiflmaxu";
  ...
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center justify-center p-[20px] relative shrink-0 w-[183px]" data-name="Input">
      ...
      <div className="flex flex-col font-['Graphik:Regular',sans-serif] justify-center leading-[0] not-italic overflow-hidden relative shrink-0 text-[14px] text-[rgba(0,0,0,0.64)] text-ellipsis tracking-[-0.14px] whitespace-nowrap" style={{ fontFeatureSettings: "'ss05'" }}>
        <p className="leading-[1.5] overflow-hidden">Entrada</p>
      </div>
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0">
      <p className="font-['Nu_Sans_Display:Medium',sans-serif] leading-[1.2] not-italic relative shrink-0 text-[#1f002f] text-[24px] text-center">$ 127.3</p>
    </div>
  );
}
...
function Input1() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center justify-center p-[20px] relative shrink-0 w-[183px]" data-name="Input">
      ...
      <Divider1 />
      <div className="flex flex-col font-['Graphik:Regular',sans-serif] justify-center leading-[0] not-italic overflow-hidden relative shrink-0 text-[14px] text-[rgba(0,0,0,0.64)] text-ellipsis tracking-[-0.14px] whitespace-nowrap" style={{ fontFeatureSettings: "'ss05'" }}>
        <p className="leading-[1.5] overflow-hidden">Parcela Mensal</p>
      </div>
    </div>
  );
}
...
function Input2() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center justify-center py-[20px] relative shrink-0 w-[375px]" data-name="Input">
      ...
      <Divider2 />
      <div className="flex flex-col font-['Graphik:Regular',sans-serif] justify-center leading-[0] not-italic overflow-hidden relative shrink-0 text-[14px] text-[rgba(0,0,0,0.64)] text-ellipsis tracking-[-0.14px] whitespace-nowrap" style={{ fontFeatureSettings: "'ss05'" }}>
        <p className="leading-[1.5] overflow-hidden">Número da parcela</p>
      </div>
      <ListGroup />
    </div>
  );
...
function Indicator() {
  return (
    <div className="absolute contents left-[21px] size-[32px] top-[-4px]" data-name="indicator">
      <div className="absolute flex items-center justify-center left-[21px] size-[32px] top-[-4px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
...
function Text() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-h-px min-w-px not-italic overflow-clip relative text-ellipsis whitespace-pre-wrap" data-name="Text">
      <p className="font-['Nu_Sans_Text:Semibold',sans-serif] leading-[1.3] overflow-hidden relative shrink-0 text-[#1f0230] text-[18px] w-full">Total: R$ 1.272,95</p>
