import svgPaths from "./svg-l6ni0stbu4";
...
function Leading() {
  return (
    <button className="-translate-y-1/2 absolute content-stretch cursor-pointer flex items-center justify-center left-[12px] overflow-clip top-1/2" data-name="Leading">
      <TouchTarget />
    </button>
  );
}
...
function Button() {
  return (
    <button className="absolute bg-[#820ad1] bottom-[45px] content-stretch cursor-pointer flex gap-[8px] h-[48px] items-end justify-center left-[18px] max-h-[48px] max-w-[359px] min-h-[48px] px-[24px] py-[12px] rounded-[64px] w-[339px]" data-name="Button">
...
function Simulation() {
  return (
    <div className="absolute h-[812px] left-0 overflow-clip rounded-[40px] top-[-2px] w-[375px]" data-name="Simulation06">
      <BottomSheet />
      <Button />
    </div>
  );
...
function BottomSheetContent() {
  return (
    <div className="absolute contents left-0 top-[-2px]" data-name="Bottom Sheet Content">
      <Simulation />
    </div>
  );
}

export default function DueDateCalendarEn() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip pb-[16px] relative rounded-[40px] size-full" data-name="Due Date Calendar EN">
      <BottomSheetContent />
    </div>
  );
}