import svgPaths from "./svg-ovnacxoevm";
...
function Divider() {
  return <div className="bg-[#efefef] h-[4px] shrink-0 w-[140px]" data-name="Divider" />;
}
...
function Divider2() {
  return <div className="bg-[#efefef] h-[4px] shrink-0 w-[160px]" data-name="Divider" />;
}
  ...
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Indicator Bar">
      ...
      <div className="-translate-y-1/2 absolute h-[4px] left-0 right-[232px] top-1/2" data-name="Indicator">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 103 4">
...
function MagicCheckoutBottomBar() {
  return (
