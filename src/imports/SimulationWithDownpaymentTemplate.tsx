import svgPaths from "./svg-2zx26jhtwd";
...
function Frame() {
  return (
    <div className="content-stretch flex items-center relative shrink-0">
      <p className="font-['Nu_Sans_Display:Medium',sans-serif] leading-[1.2] not-italic relative shrink-0 text-[#1f002f] text-[24px] text-center">$ 500.00</p>
    </div>
  );
}
...
function Input() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center justify-center p-[20px] relative shrink-0 w-[183px]" data-name="Input">
      <Big />
      <div className="bg-[#efefef] h-[4px] shrink-0 w-[140px]" data-name="Divider" />
      <div className="flex flex-col font-['Graphik:Regular',sans-serif] justify-center leading-[0] not-italic overflow-hidden relative shrink-0 text-[14px] text-[rgba(0,0,0,0.64)] text-ellipsis tracking-[-0.14px] whitespace-nowrap" style={{ fontFeatureSettings: "'ss05'" }}>
        <p className="leading-[1.5] overflow-hidden">Downpayment</p>
      </div>
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0">
      <p className="font-['Nu_Sans_Display:Medium',sans-serif] leading-[1.2] not-italic relative shrink-0 text-[#1f002f] text-[24px] text-center">$ 127.30</p>
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-full">
      <Input />
      <div className="flex h-[90px] items-center justify-center relative shrink-0 w-0" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "18" } as React.CSSProperties}>
          ...
          <div className="h-0 relative w-[90px]">
            <div className="absolute inset-[-1px_0_0_0]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 90 1">
                <line id="Line 7" stroke="var(--stroke-0, #1F0230)" strokeOpacity="0.08" x2="90" y1="0.5" y2="0.5" />
              </svg>
            </div>
          </div>
        </div>
...
function Frame2() {
  return (
    <div className="content-stretch flex items-center relative shrink-0">
      <p className="font-['Graphik:Medium',sans-serif] leading-[1.1] not-italic relative shrink-0 text-[#1f0230] text-[44px] text-center tracking-[-1.32px]" style={{ fontFeatureSettings: "'ss05'" }}>
        20
      </p>
    </div>
  );
...
function Input2() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center justify-center py-[20px] relative shrink-0 w-[375px]" data-name="Input">
      <Big2 />
      <div className="bg-[#efefef] h-[4px] shrink-0 w-[160px]" data-name="Divider" />
      <div className="flex flex-col font-['Graphik:Regular',sans-serif] justify-center leading-[0] not-italic overflow-hidden relative shrink-0 text-[14px] text-[rgba(0,0,0,0.64)] text-ellipsis tracking-[-0.14px] whitespace-nowrap" style={{ fontFeatureSettings: "'ss05'" }}>
...
function Indicator() {
  return (
    <div className="absolute contents left-[86px] size-[32px] top-[-4px]" data-name="indicator">
      <div className="absolute flex items-center justify-center left-[86px] size-[32px] top-[-4px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "18" } as React.CSSProperties}>
...
function IndicatorBar() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Indicator Bar">
      ...
      <div className="-translate-y-1/2 absolute h-[4px] left-0 right-[232px] top-1/2" data-name="Indicator">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 103 4">
          <path d={svgPaths.p26832f0} fill="var(--fill-0, #820AD1)" id="Indicator" />
        </svg>
      </div>
      <Indicator />
    </div>
...
function Text() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-h-px min-w-px not-italic overflow-clip relative text-ellipsis whitespace-pre-wrap" data-name="Text">
      <p className="font-['Nu_Sans_Text:Semibold',sans-serif] leading-[1.3] overflow-hidden relative shrink-0 text-[#1f0230] text-[18px] w-full">Total: $ 1,272.95</p>
...
export default function SimulationWithDownpaymentTemplate() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start overflow-clip pb-[16px] relative rounded-[40px] size-full" data-name="Simulation with Downpayment Template">
      <div className="content-stretch flex flex-col h-[244px] items-center relative shrink-0 w-[375px]" data-name="[Magic] Header">
        <Content />
      </div>
      <Frame3 />
      <Input2 />
