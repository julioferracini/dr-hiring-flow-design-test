import svgPaths from "./svg-h41wupleqo";
...
function Frame() {
  return (
    <div className="content-stretch flex items-center relative shrink-0">
      <p className="font-['Nu_Sans_Display:Medium',sans-serif] leading-[1.2] not-italic relative shrink-0 text-[#1f002f] text-[24px] text-center">$ 99,99</p>
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0">
      <p className="font-['Nu_Sans_Display:Medium',sans-serif] leading-[1.2] not-italic relative shrink-0 text-[#1f002f] text-[24px] text-center">$ 999,99</p>
    </div>
  );
}
...
function Indicator() {
  return (
    <div className="absolute contents left-[80px] size-[44px] top-[-10px]" data-name="indicator">
      <div className="absolute flex items-center justify-center left-[80px] size-[44px] top-[-10px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
        <div className="-rotate-90 flex-none">
          <div className="relative size-[44px]">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 44 44">
              <circle cx="22" cy="22" fill="var(--fill-0, #820AD1)" id="Ellipse 597" r="22" />
            </svg>
          </div>
        </div>
      </div>
