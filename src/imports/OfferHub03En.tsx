import svgPaths from "./svg-67448kky12";
...
function Segment() {
  return (
    <div className="bg-[rgba(31,2,48,0)] flex-[1_0_0] h-[44px] min-h-px min-w-px relative rounded-[999px]" data-name="Segment 2">
...
function Content3() {
  return (
    <div className="content-stretch flex gap-[8px] items-start relative shrink-0" data-name="Content">
      <div className="flex flex-col font-['Nu_Sans_Text:Semibold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#820ad1] text-[12px] whitespace-nowrap" style={{ fontFeatureSettings: "\'lnum\', \'tnum\'" }}>
...
function Segment1() {
  return (
    <div className="bg-white flex-[1_0_0] h-[44px] min-h-px min-w-px relative rounded-[999px]" data-name="Segment 3">
  ...
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-center px-[110px] py-[7px] relative shrink-0 w-[336px]" data-name="Numbers">
      <div className="flex flex-col font-['Nu_Sans_Display:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1f0230] text-[36px] text-center whitespace-nowrap">
        <p className="leading-[1.1]">$876.50</p>
      </div>
      <TrailingContent />
    </div>
  );
  ...
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0" data-name="A">
      ...
      <p className="font-['Nu_Sans_Text:Regular',sans-serif] leading-[0] not-italic overflow-hidden relative shrink-0 text-[12px] text-[rgba(31,2,48,0.62)] text-center text-ellipsis tracking-[0.12px]" style={{ fontFeatureSettings: "\'lnum\', \'tnum\'" }}>
        ...
        <span className="[text-decoration-skip-ink:none] decoration-solid font-['Graphik:Regular',sans-serif] leading-[1.3] line-through" style={{ fontFeatureSettings: "\'lnum\', \'tnum\'" }}>{`$1,076.50 `}</span>
...
function PaymentInfo() {
  return (
    <div className="content-stretch flex gap-[4px] items-start leading-[1.3] not-italic relative shrink-0 text-[12px] text-ellipsis" data-name="Payment Info">
      ...
      <p className="font-['Graphik:Medium',sans-serif] overflow-hidden relative shrink-0 text-[rgba(0,0,0,0.96)]" style={{ fontFeatureSettings: "\'lnum\', \'tnum\'" }}>{` $320.00`}</p>
    </div>
  );
}
...
function Scroll() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[812px] items-start left-0 pb-[16px] rounded-[40px] top-0 w-[375px]" data-name="Scroll">
      <Content1 />
    </div>
  );
}

export default function OfferHub03En() {
  return (
    <div className="overflow-clip relative rounded-[40px] size-full" data-name="Offer Hub 03 EN">
      <Header />
      <Scroll />
    </div>
  );
