import svgPaths from "./svg-gt80qepr9o";
...
function Frame3() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-full">
      <Input />
      <div className="flex h-[90px] items-center justify-center relative shrink-0 w-0" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
...
function Indicator() {
  return (
    <div className="absolute contents left-[86px] size-[32px] top-[-4px]" data-name="indicator">
      <div className="absolute flex items-center justify-center left-[86px] size-[32px] top-[-4px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
