import svgPaths from "./svg-1takxkd3eo";
      ...
      <div className="relative shrink-0 size-[20px]" data-name="[Magic] Icon">
        <div className="absolute inset-[8.33%_7.69%_8.33%_8.97%]" data-name="Icon">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16.6667 16.6667">
            <g id="Icon">
              <path d={svgPaths.p2085d070} fill="var(--fill-0, #1F0230)" fillOpacity="0.62" />
              <path d={svgPaths.p2c7f7180} fill="var(--fill-0, #1F0230)" fillOpacity="0.62" />
              <path d={svgPaths.p26903680} fill="var(--fill-0, #1F0230)" fillOpacity="0.62" />
            </g>
          </svg>
        </div>
      </div>
...
function TouchTarget() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 size-[44px]" data-name="Touch Target">
      <div className="content-stretch flex items-center justify-center max-h-[44px] max-w-[44px] min-h-[44px] min-w-[44px] relative rounded-[64px] shrink-0 size-[44px]" data-name="1st Action">
        <IconAction />
      </div>
    </div>
  );
...
function Trailing() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex items-center overflow-clip right-[10px] top-1/2" data-name="Trailing">
      <TouchTarget />
    </div>
  );
}
