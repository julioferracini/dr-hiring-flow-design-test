import svgPaths from "./svg-56sa6mjw5b";
...
function Numbers() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-center px-[110px] py-[7px] relative shrink-0 w-[336px]" data-name="Numbers">
      <div className="flex flex-col font-['Nu_Sans_Display:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1f0230] text-[36px] text-center whitespace-nowrap" style={{ fontFeatureSettings: "\'lnum\', \'pnum\'" }}>
