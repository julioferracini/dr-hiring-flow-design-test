import svgPaths from "./svg-khcy39f05g";
...
function Trailing() {
  return <div className="content-stretch flex flex-col h-[40px] items-start min-w-[40px] shrink-0 w-[72px]" data-name="Trailing" />;
}
