import svgPaths from "./svg-vw4w5r40sn";
    ...
    <div className="relative shrink-0 w-full" data-name="Title">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[8px] items-start pb-[20px] pt-[12px] px-[20px] relative w-full">
          <p className="font-['Graphik:Medium',sans-serif] leading-[1.1] not-italic relative shrink-0 text-[#1f0230] text-[36px] tracking-[-1.08px] w-full whitespace-pre-wrap" style={{ fontFeatureSettings: "\'ss05\'" }}>
            When can you make the Downpayment?
          </p>
        </div>
      </div>
    </div>
...
function TopDivider() {
  return <div className="h-px shrink-0 w-full z-[3]" data-name="Top divider" />;
}
  ...
  return (
    <div className="content-stretch flex items-start relative shrink-0 w-full" data-name="Primary Wrapper">
      <div className="flex flex-col font-['Graphik:Medium',sans-serif] justify-center leading-[0] not-italic relative self-stretch shrink-0 text-[14px] text-[rgba(0,0,0,0.96)] tracking-[-0.14px] w-[245px]" style={{ fontFeatureSettings: "\'lnum\', \'tnum\'" }}>
        <p className="leading-[1.3] whitespace-pre-wrap">Downpayment: $78.48</p>
      </div>
    </div>
  );
}
...
function PrimaryWrapper1() {
  return (
    <div className="content-stretch flex items-start relative shrink-0 w-full" data-name="Primary Wrapper">
      <div className="flex flex-col font-['Graphik:Medium',sans-serif] justify-center leading-[0] not-italic relative self-stretch shrink-0 text-[14px] text-[rgba(0,0,0,0.96)] tracking-[-0.14px] w-[245px]" style={{ fontFeatureSettings: "\'lnum\', \'tnum\'" }}>
        <p className="leading-[1.3] whitespace-pre-wrap">24 installments of $48.38</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Description Wrapper">
      <div className="flex flex-col font-['Graphik:Regular',sans-serif] h-full justify-center leading-[1.3] not-italic relative shrink-0 text-[0px] text-[12px] text-[rgba(0,0,0,0.64)] w-[245px] whitespace-pre-wrap" style={{ fontFeatureSettings: "\'lnum\', \'tnum\'" }}>
        ...
        <p style={{ fontFeatureSettings: "\'lnum\', \'tnum\'" }}>Total: $1337.37</p>
      </div>
    </div>
  );
}
...
export default function DueDateSelectEn() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start overflow-clip pb-[16px] relative rounded-[40px] size-full" data-name="Due Date Select EN">
      <Header />
      <DueDate />
      <HomeIndicator />
    </div>
