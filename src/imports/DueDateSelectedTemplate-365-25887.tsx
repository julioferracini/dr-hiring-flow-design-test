import svgPaths from "./svg-n84rktp52s";
...
function PrimaryWrapper() {
  return (
    <div className="content-stretch flex gap-[4px] items-start leading-[0] not-italic relative shrink-0 text-[14px] text-[rgba(0,0,0,0.96)] tracking-[-0.14px] w-full whitespace-nowrap" data-name="Primary Wrapper">
      <div className="flex flex-col font-['Graphik:Regular',sans-serif] justify-center relative shrink-0" style={{ fontFeatureSettings: "\'lnum\', \'tnum\'" }}>
        <p className="leading-[1.3]">Downpayment</p>
      </div>
      <div className="flex flex-col font-['Graphik:Medium',sans-serif] justify-center relative shrink-0" style={{ fontFeatureSettings: "\'lnum\', \'tnum\'" }}>
        <p className="leading-[1.3]">$200.00</p>
      </div>
    </div>
  );
}
...
function ArrowDivider() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Arrow Divider">
      <Divider />
    </div>
  );
}

function PrimaryWrapper1() {
  return (
    <div className="content-stretch flex gap-[4px] items-start leading-[0] not-italic relative shrink-0 text-[14px] text-[rgba(0,0,0,0.96)] tracking-[-0.14px] w-full whitespace-nowrap" data-name="Primary Wrapper">
      <div className="flex flex-col font-['Graphik:Regular',sans-serif] justify-center relative shrink-0" style={{ fontFeatureSettings: "\'lnum\', \'tnum\'" }}>
        <p className="leading-[1.3]">{`10 installments of `}</p>
      </div>
      <div className="flex flex-col font-['Graphik:Medium',sans-serif] justify-center relative shrink-0" style={{ fontFeatureSettings: "\'lnum\', \'tnum\'" }}>
        <p className="leading-[1.3]">R$ 127,36</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Description Wrapper">
      <div className="flex flex-col font-['Graphik:Regular',sans-serif] h-full justify-center leading-[1.3] not-italic relative shrink-0 text-[0px] text-[12px] text-[rgba(0,0,0,0.64)] w-[245px] whitespace-pre-wrap" style={{ fontFeatureSettings: "\'lnum\', \'tnum\'" }}>
        ...
        <p style={{ fontFeatureSettings: "\'lnum\', \'tnum\'" }}>Total: $1,264.60</p>
      </div>
    </div>
  );
}
      ...
      <div className="flex flex-row items-center max-h-[inherit] min-h-[inherit] size-full">
        <div className="content-stretch flex gap-[8px] items-center max-h-[inherit] min-h-[inherit] pl-[20px] pr-[8px] relative size-full">
          <div className="flex flex-[1_0_0] flex-col font-['Graphik:Medium',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[16px] text-[rgba(0,0,0,0.96)] tracking-[-0.16px]" style={{ fontFeatureSettings: "\'lnum\', \'tnum\'" }}>
            <p className="leading-[1.3] whitespace-pre-wrap">Data de vencimento</p>
          </div>
          <Secondary />
        </div>
      </div>
...
function Content3() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[2px] items-start leading-[1.3] min-h-px min-w-px not-italic relative text-[#820ad1] text-[12px] whitespace-pre-wrap" data-name="Content">
      <p className="font-['Graphik:Medium',sans-serif] relative shrink-0 w-full" style={{ fontFeatureSettings: "\'lnum\', \'tnum\'" }}>
        Jun 16
      </p>
      <p className="font-['Graphik:Regular',sans-serif] relative shrink-0 w-full" style={{ fontFeatureSettings: "\'lnum\', \'tnum\'" }}>
        Today
      </p>
    </div>
  );
...
function Tile() {
  return (
    <div className="bg-[#faf6ff] flex-[1_0_0] min-h-px min-w-px relative rounded-[16px]" data-name="Tile 1">
      ...
      <div aria-hidden="true" className="absolute border border-[#820ad1] border-solid inset-0 pointer-events-none rounded-[16px]" />
    </div>
  );
}
...
export default function DueDateSelectedTemplate() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start overflow-clip pb-[16px] relative rounded-[40px] size-full" data-name="Due Date Selected Template">
      <Header />
      <BottomWrapper />
    </div>
  );
